...
def calculate_ssim(img1, img2, window, window_size, channel, size_average = True):
...
class SSIMLoss(nn.Module):
    ...
    def forward(self, img1, img2):
        ...
        return -calculate_ssim(img1, img2, self.window, self.window_size, channel, self.size_average)
